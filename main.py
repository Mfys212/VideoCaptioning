...
class CreateModel():
    ...
    def DefineModel(self, D_MODELS, NUM_HEADS, MAX_FRAMES, SPATIAL_SIZE, 
    ...
    def SpatioTemporalAttention(self):
        pass
    ...
    def CrossAttention(self, D_MODELS, NUM_HEADS, MAX_FRAMES, SPATIAL_SIZE, 
        ...
        if self.multigpu == True:
            with strategy.scope():
                encoder, decoder, model = self.DefineModel(D_MODELS, NUM_HEADS, MAX_FRAMES, SPATIAL_SIZE, 
                                                            NUM_PATCH, VOCAB_SIZE, SEQ_LENGTH, NUM_L)
        else:
            encoder, decoder, model = self.DefineModel(D_MODELS, NUM_HEADS, MAX_FRAMES, SPATIAL_SIZE, 
                                                        NUM_PATCH, VOCAB_SIZE, SEQ_LENGTH, NUM_L)  
